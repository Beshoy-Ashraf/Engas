...
public interface IStoreStockService
{
      ...
      Task<List<ItemsInStores>> GetItemInStores(Guid id, CancellationToken cancellationToken);
      ...
      Task<List<ItemsInStores>> GetStoreItems(Guid id, CancellationToken cancellationToken);
}
